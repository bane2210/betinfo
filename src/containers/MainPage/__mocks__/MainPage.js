...
const LeagueList_1 = __importDefault(
  require("../../components/LeagueList/LeagueList")
);
const NavDates_1 = __importDefault(
  require("../../components/NavDates/NavDates")
);
...
const Marketing_1 = __importDefault(
  require("../../components/Marketing/Marketing")
);
...
const MainPage = (props) => {
  ...
  (0, react_1.useEffect)(() => {
    if (state.dateSet !== "") {
      ...
      dispatch(
        (0, createSlice_1.restoreDateAction)({
          date: state.dateSet,
  ...
  if (!state.loadSpinner) {
    content = (0, jsx_runtime_1.jsxs)(AuxAux_1.default, {
      children: [
        (0, jsx_runtime_1.jsx)(BettingBox_1.default, {
          date: state.dateSetAllways,
        }),
        props.m === ""
          ? null
          : (0, jsx_runtime_1.jsx)(
              "div",
              Object.assign(
                { className: MainPage_module_css_1.default.mark },
                {
                  children: (0, jsx_runtime_1.jsx)(Marketing_1.default, {
                    m: props.m,
                    type: "",
                  }),
                }
        ...
        (0, jsx_runtime_1.jsx)(LeagueList_1.default, {
          dateSet: state.dateSetAllways,
          games: state.games,
        }),
      ],
    });
  ...
  return (0, jsx_runtime_1.jsxs)(
    "div",
    Object.assign(
      { className: MainPage_module_css_1.default.Aux, id: "mainPage" },
      {
        children: [
          (0, jsx_runtime_1.jsx)(NavDates_1.default, {
            change: changeUrl,
            position: state.positionButton,
          }),
          content,
