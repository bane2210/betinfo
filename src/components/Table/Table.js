...
class Table extends Component {
    ...
    setTable = () => {
        ...
        console.log(tableFull.style.display);
    ...
    render() {
        ...
        return (
            <div>
                {content}
                <div className={"tableBottom"} onClick={this.setTable}> Table
                <div id="arrowUp" style={{ marginLeft: "10px", display: "inline-block" }}><i className="fa fa-arrow-up" aria-hidden="true"></i></div>
                    <div id="arrowDown" style={{ marginLeft: "10px", display: "none" }}><i className="fa fa-arrow-down" aria-hidden="true"></i></div>
                </div>
            </div>
        );
    }
