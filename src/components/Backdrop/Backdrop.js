...
const Backdrop_module_css_1 = __importDefault(require("./Backdrop.module.css"));
const Spinner_1 = __importDefault(require("../Spinner/Spinner"));
const axios_1 = __importDefault(require("axios"));
const MatchTitle_1 = __importDefault(require("../MatchHomeBox/MatchTitle/MatchTitle"));
const MatchHomeBox_1 = __importDefault(require("../MatchHomeBox/MatchHomeBox"));
const MatchAwayBox_1 = __importDefault(require("../MatchAwayBox/MatchAwayBox"));
const Table_1 = __importDefault(require("../Table/Table"));
const BackdropClose_1 = __importDefault(require("./BackdropClose"));
const SingleBettingBox_1 = __importDefault(require("./SingleBettingBox/SingleBettingBox"));
const react_redux_1 = require("react-redux");
const createSlice_1 = require("../../store/createSlice");
const Backdrop = (props) => {
    let state;
    let setState;
    [state, setState] = (0, react_1.useState)();
    ...
    (0, react_1.useEffect)(() => {
        ...
        const url = "/api_stats/singleMatch.php?country=" +
    ...
    const finalResultsFun = (final_results, element) => {
        ...
        let secHalfGoals = element.homeScoreSecondHalf + element.awayScoreSecondHalf;
        if (secHalfGoals > 0) {
        ...
        else if (element.homeScoreFirstHalf + element.awayScoreFirstHalf <
            element.homeScoreSecondHalf + element.awayScoreSecondHalf) {
    ...
    const complexStats = (response) => {
        ...
        json_result.map((element) => {
            ...
            if (sqlDate.getTime() > matchDate.getTime() ||
            ...
            if ((homeTeam === element.homeTeam || homeTeam === element.awayTeam) &&
                end) {
            ...
            if ((awayTeam === element.homeTeam || awayTeam === element.awayTeam) &&
                end) {
    ...
    // window.scrollTo(0, 0);
    let content = ((0, jsx_runtime_1.jsx)("div", Object.assign({ className: Backdrop_module_css_1.default.spinnerBox }, { children: (0, jsx_runtime_1.jsx)(Spinner_1.default, {}) })));
    console.log(typeof state !== "undefined" && state.spinner === false);
    if (typeof state !== "undefined" && state.spinner === false) {
        content = ((0, jsx_runtime_1.jsxs)("div", Object.assign({ className: Backdrop_module_css_1.default.Backdrop }, { children: [(0, jsx_runtime_1.jsx)(BackdropClose_1.default, { click: goback }), (0, jsx_runtime_1.jsx)(MatchTitle_1.default, { date: props.date, t: props.t, comp: props.comp, co: props.country, h: props.h, a: props.a }), (0, jsx_runtime_1.jsx)(SingleBettingBox_1.default, { homeOBJHome: state.homeOBJHome, homeOBJAll: state.homeOBJAll, awayOBJAway: state.awayOBJAway, awayOBJAll: state.awayOBJAll, final_results: state.final_results }), (0, jsx_runtime_1.jsx)(MatchHomeBox_1.default, { h: props.h, homeOBJHome: state.homeOBJHome, homeOBJAll: state.homeOBJAll, homeOBJHome_games: state.homeOBJHome_games, homeOBJAll_games: state.homeOBJAll_games, homeOBJHome_list: state.homeOBJHome_list, homeOBJAll_list: state.homeOBJAll_list, object: state.h2h }), (0, jsx_runtime_1.jsx)(MatchAwayBox_1.default, { a: props.a, awayOBJAway: state.awayOBJAway, awayOBJAll: state.awayOBJAll, awayOBJAway_games: state.awayOBJAway_games, awayOBJAll_games: state.awayOBJAll_games, awayOBJAway_list: state.awayOBJAway_list, awayOBJAll_list: state.awayOBJAll_list, object: state.h2h }), (0, jsx_runtime_1.jsx)("div", Object.assign({ className: Backdrop_module_css_1.default.tableContainer }, { children: (0, jsx_runtime_1.jsx)(Table_1.default, { table: state.table }) }))] })));
    }
    return ((0, jsx_runtime_1.jsx)("div", Object.assign({ id: "backdrop", className: Backdrop_module_css_1.default.Backdrop }, { children: content })));
};
