...
import { MainOBject } from "../Backdrop";
...
type StateType = {
    recomended: boolean,
    couldTry: boolean,
    recomendedObj: [] | RecommendedCouldTry[],
    couldTryObj: [] | RecommendedCouldTry[],
}

const SingleBettingBox = (props: Props) => {
  ...
  const calcChance = (home: keyof MainOBject, away: keyof MainOBject, br: number) => {
    ...
    const customHome = home + "SER" as keyof MainOBject;
    const customAway = away + "SER" as keyof MainOBject;
    ...
    if (h1_count > 3 && a1_count > 3) {
      ...
      let h1_perc = parseInt(((homeOBJHome[home] as number / h1_count) * 100).toFixed(0));
      let h2_perc = parseInt(((homeOBJAll[home] as number / h2_count) * 100).toFixed(0));
      let a1_perc = parseInt(((awayOBJAway[away] as number / a1_count) * 100).toFixed(0));
      let a2_perc = parseInt(((awayOBJAll[away] as number / a2_count) * 100).toFixed(0));
      ...
      if (
        ...
        if (
          (homeOBJHome[customHome] > 5 || homeOBJAll[customHome] > 5) &&
        ...
        if (
          (homeOBJHome[customHome] > 2 || homeOBJAll[customHome] > 2) &&
      ...
      if (
        (homeChance < borderPerc || awayChance < borderPerc) &&
        homeChance < 98 &&
        awayChance < 98
      )
        border = false;
      ...
      if (home === "gibh") {
        ...
        if (a_h1_perc.total > 82 || a_a1_perc.total > 84) {
          totalChance += parseInt(
            (
              ((a_h1_perc.total + a_a1_perc.total) / 2 - totalChance) /
              4
            ).toFixed(0)
          );
        }
  ...
  const calcBettingTips = () => {
    let recomendedObj: RecommendedCouldTry[] = [];
    let couldTryObj: RecommendedCouldTry[] = [];
    let tip: string = "";
    ...
    if (chance.total >= 65) {
      ...
      explanation.push(
        homeTeam + " won " + chance.h1_perc + "% of their home games"
      );
      if (chance.h1_perc < chance.h2_perc) {
        explanation.push(
          homeTeam + " won " + chance.h2_perc + "% of all the games"
        );
      }
      ...
      explanation.push(
        awayTeam + " lost " + chance.a1_perc + "% of their away games"
      );
      if (chance.a1_perc < chance.a2_perc) {
        explanation.push(
          awayTeam + " lost " + chance.a2_perc + "% of all the games"
        );
      }
    ...
    if (chance.total >= 45) {
      ...
      explanation.push(
        chance.h1_perc + "% of " + homeTeam + " home games ended without winner"
      );
      if (chance.h1_perc < chance.h2_perc) {
        explanation.push(
          chance.h2_perc +
      ...
      explanation.push(
        chance.a1_perc + "% of " + awayTeam + " away games ended without winner"
      );
      if (chance.a1_perc < chance.a2_perc) {
        explanation.push(
          chance.a2_perc +
    ...
    if (chance.total >= 65) {
      ...
      explanation.push(
        homeTeam + " lost " + chance.h1_perc + "% of their home games"
      );
      if (chance.h1_perc < chance.h2_perc) {
        explanation.push(
          homeTeam + " lost " + chance.h2_perc + "% of all the games"
        );
      }
      ...
      explanation.push(
        awayTeam + " won " + chance.a1_perc + "% of their away games"
      );
      if (chance.a1_perc < chance.a2_perc) {
        explanation.push(
          awayTeam + " won " + chance.a2_perc + "% of all the games"
        );
      }
    ...
    if (chance.total >= 85) {
      ...
      explanation.push(
        homeTeam + " scored in " + chance.h1_perc + "% of their home games"
      );
      if (chance.h1_perc < chance.h2_perc) {
        explanation.push(
          homeTeam + " scored in " + chance.h2_perc + "% of all the games"
        );
      }
    ...
    if (chance.total >= 85) {
      ...
      explanation.push(
        awayTeam + " scored in " + chance.a1_perc + "% of their away games"
      );
      if (chance.a1_perc < chance.a2_perc) {
        explanation.push(
          awayTeam + " scored in " + chance.a2_perc + "% of all the games"
        );
      }
    ...
    if (chance.total >= 70) {
      ...
      if (chance.h1_perc < chance.h2_perc) {
        explanation.push(
          homeTeam + " scored twice in " + chance.h2_perc + "% of all the games"
        );
      }
    ...
    if (chance.total >= 70) {
      ...
      if (chance.a1_perc < chance.a2_perc) {
        explanation.push(
          awayTeam + " scored twice in " + chance.a2_perc + "% of all the games"
        );
      }
    ...
    if (chance.total >= 85) {
      ...
      explanation.push(
        "Over 1.5 goals have been scored in " +
          chance.h1_perc +
          "% of " +
          homeTeam +
          " home games"
      ...
      if (props.homeOBJHome.over_1_5SER > 2) {
        explanation.push(
          "Over 1.5 goals have been scored in the last " +
    ...
    if (chance.total >= 70) {
      ...
      explanation.push(
        "Over 2.5 goals have been scored in " +
          chance.h1_perc +
          "% of " +
          homeTeam +
          " home games"
      ...
      if (props.homeOBJHome.over_2_5SER > 2) {
        explanation.push(
          "Over 2.5 goals have been scored in the last " +
    ...
    if (chance.total >= 55) {
      ...
      explanation.push(
        "Over 3.5 goals have been scored in " +
          chance.h1_perc +
          "% of " +
          homeTeam +
          " home games"
      ...
      if (props.homeOBJHome.over_3_5SER > 2) {
        explanation.push(
          "Over 3.5 goals have been scored in the last " +
    ...
    if (chance.total >= 45) {
      ...
      explanation.push(
        "Over 4.5 goals have been scored in " +
          chance.h1_perc +
          "% of " +
          homeTeam +
          " home games"
      ...
      if (props.homeOBJHome.over_4_5SER > 2) {
        explanation.push(
          "Over 4.5 goals have been scored in the last " +
    ...
    if (chance.total >= 40) {
      ...
      explanation.push(
        "Over 5.5 goals have been scored in " +
          chance.h1_perc +
          "% of " +
          homeTeam +
          " home games"
      ...
      if (props.homeOBJHome.over_5_5SER > 2) {
        explanation.push(
          "Over 5.5 goals have been scored in the last " +
    ...
    if (chance.total >= 60) {
      ...
      explanation.push(
        "Under 1.5 goals have been scored in " +
          chance.h1_perc +
          "% of " +
          homeTeam +
          " home games"
      ...
      if (props.homeOBJHome.under_1_5SER > 2) {
        explanation.push(
          "Under 1.5 goals have been scored in the last " +
    ...
    if (chance.total >= 65) {
      ...
      explanation.push(
        "Under 2.5 goals have been scored in " +
          chance.h1_perc +
          "% of " +
          homeTeam +
          " home games"
      ...
      if (props.homeOBJHome.under_2_5SER > 2) {
        explanation.push(
          "Under 2.5 goals have been scored in the last " +
    ...
    if (chance.total >= 80) {
      ...
      explanation.push(
        "Over 0.5 goals at HT have been scored in " +
          chance.h1_perc +
          "% of " +
          homeTeam +
          " home games"
      ...
      if (props.homeOBJHome.over_0_5_HTSER > 2) {
        explanation.push(
          "Over 0.5 goals at HT have been scored in the last " +
    ...
    if (chance.total >= 60) {
      ...
      explanation.push(
        "Over 1.5 goals at HT have been scored in " +
          chance.h1_perc +
          "% of " +
          homeTeam +
          " home games"
      ...
      if (props.homeOBJHome.over_1_5_HTSER > 2) {
        explanation.push(
          "Over 1.5 goals at HT have been scored in the last " +
    ...
    if (chance.total >= 50) {
      ...
      explanation.push(
        "Over 2.5 goals at HT have been scored in " +
          chance.h1_perc +
          "% of " +
          homeTeam +
          " home games"
      ...
      if (props.homeOBJHome.over_2_5_HTSER > 2) {
        explanation.push(
          "Over 2.5 goals at HT have been scored in the last " +
    ...
    if (chance.total >= 82) {
      ...
      explanation.push(
        "Over 0.5 goals at second half have been scored in " +
          chance.h1_perc +
          "% of " +
          homeTeam +
          " home games"
      ...
      if (props.homeOBJHome.over_0_5_SHSER > 2) {
        explanation.push(
          "Over 0.5 goals at second half have been scored in the last " +
    ...
    if (chance.total >= 65) {
      ...
      explanation.push(
        "Over 1.5 goals at second half have been scored in " +
          chance.h1_perc +
          "% of " +
          homeTeam +
          " home games"
      ...
      if (props.homeOBJHome.over_1_5_SHSER > 2) {
        explanation.push(
          "Over 1.5 goals at second half have been scored in the last " +
    ...
    if (chance.total >= 50) {
      ...
      explanation.push(
        "Over 2.5 goals at second half have been scored in " +
          chance.h1_perc +
          "% of " +
          homeTeam +
          " home games"
      ...
      if (props.homeOBJHome.over_2_5_SHSER > 2) {
        explanation.push(
          "Over 2.5 goals at second half have been scored in the last " +
    ...
    if (chance.total >= 48) {
      ...
      explanation.push(
        "Both teams have scored in the first half in " +
          chance.h1_perc +
          "% of " +
          homeTeam +
          " home games"
      ...
      if (props.homeOBJHome.btsFHSER > 2) {
        explanation.push(
          "Both teams have scored in the first half in the last " +
    ...
    if (chance.total >= 55) {
      ...
      explanation.push(
        "Both teams have scored in the second half in " +
          chance.h1_perc +
          "% of " +
          homeTeam +
          " home games"
      ...
      if (props.homeOBJHome.BTTS_SHSER > 2) {
        explanation.push(
          "Both teams have scored in the second half in the last " +
    ...
    if (chance.total >= 65) {
      ...
      explanation.push(
        "BTTS and over 2.5 goals have been scored in " +
          chance.h1_perc +
          "% of " +
          homeTeam +
          " home games"
      ...
      if (props.homeOBJHome.btts3SER > 2) {
        explanation.push(
          "BTTS and over 2.5 goals have been scored in the last " +
    ...
    if (chance.total >= 55) {
      ...
      if (chance.a1_perc < chance.a2_perc) {
        explanation.push(
          awayTeam + " conceded in both halves in " + chance.a2_perc + "% games"
        );
      }
    ...
    if (chance.total >= 70) {
      ...
      explanation.push(
        "Goal in both halves have been scored in " +
          chance.h1_perc +
          "% of " +
          homeTeam +
          " home games"
      ...
      if (props.homeOBJHome.gibhSER > 2) {
        explanation.push(
          "Goal in both halves have been scored in the last " +
    ...
    if (chance.total >= 55) {
      ...
      explanation.push(
        "More goals have been scored in the first half in " +
          chance.h1_perc +
          "% of " +
          homeTeam +
          " home games"
      ...
      if (props.homeOBJHome.more_FHSER > 2) {
        explanation.push(
          "More goals have been scored in the first half in the last " +
    ...
    if (chance.total >= 65) {
      ...
      explanation.push(
        "More goals have been scored in the second half in " +
          chance.h1_perc +
          "% of " +
          homeTeam +
          " home games"
      ...
      if (props.homeOBJHome.more_SHSER > 2) {
        explanation.push(
          "More goals have been scored in the second half in the last " +
  ...
  if (props.final_results.isSet) {
    result = (
      <div className={classes.result}>Result: {props.final_results.result}</div>
    );
  }
  ...
  if (state.recomended) {
    if (state.recomendedObj.length > 0) {
      ...
      content = (
        <div className={classes.noTips}>No available tips for this match.</div>
      );
    }
  } else {
