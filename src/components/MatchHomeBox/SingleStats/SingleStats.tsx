  ...
  if (state.single) {
    ...
    contentBTTS = (
      <ul>
        ...
        <StatsLine
          br={((homeOBJHome.win_BTTS / homeOBJHome.gamesCount) * 100).toFixed(
            0
          )}
        ...
        <StatsLine
          br={((homeOBJHome.draw_BTTS / homeOBJHome.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Draw and BTTS"}
        ...
        <StatsLine
          br={((homeOBJHome.lose_BTTS / homeOBJHome.gamesCount) * 100).toFixed(
            0
          )}
    ...
    contentOU = (
      <ul>
        <StatsLine
          br={((homeOBJHome.over_1_5 / homeOBJHome.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Over 1.5 goals"}
        ...
        <StatsLine
          br={((homeOBJHome.over_2_5 / homeOBJHome.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Over 2.5 goals"}
        ...
        <StatsLine
          br={((homeOBJHome.over_3_5 / homeOBJHome.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Over 3.5 goals"}
        ...
        <StatsLine
          br={((homeOBJHome.over_4_5 / homeOBJHome.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Over 4.5 goals"}
        ...
        <StatsLine
          br={((homeOBJHome.over_5_5 / homeOBJHome.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Over 5.5 goals"}
        ...
        <StatsLine
          br={((homeOBJHome.under_1_5 / homeOBJHome.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Under 1.5 goals"}
        ...
        <StatsLine
          br={((homeOBJHome.under_2_5 / homeOBJHome.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Under 2.5 goals"}
    ...
    contentOUHTFT = (
      <ul>
        <StatsLine
          br={(
            (homeOBJHome.over_0_5_HT / homeOBJHome.gamesCount) *
            100
          ).toFixed(0)}
        ...
        <StatsLine
          br={(
            (homeOBJHome.over_1_5_HT / homeOBJHome.gamesCount) *
            100
          ).toFixed(0)}
        ...
        <StatsLine
          br={(
            (homeOBJHome.over_2_5_HT / homeOBJHome.gamesCount) *
            100
          ).toFixed(0)}
        ...
        <StatsLine
          br={(
            (homeOBJHome.over_0_5_SH / homeOBJHome.gamesCount) *
            100
          ).toFixed(0)}
        ...
        <StatsLine
          br={(
            (homeOBJHome.over_1_5_SH / homeOBJHome.gamesCount) *
            100
          ).toFixed(0)}
        ...
        <StatsLine
          br={(
            (homeOBJHome.over_2_5_SH / homeOBJHome.gamesCount) *
            100
          ).toFixed(0)}
    ...
    contentHTFT = (
      <ul>
        <StatsLine
          br={((homeOBJHome.home_home / homeOBJHome.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Win HT - Win FT"}
        ...
        <StatsLine
          br={((homeOBJHome.home_draw / homeOBJHome.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Win HT - Draw FT"}
        ...
        <StatsLine
          br={((homeOBJHome.home_away / homeOBJHome.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Win HT - Lose FT"}
        ...
        <StatsLine
          br={((homeOBJHome.draw_home / homeOBJHome.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Draw HT - Win FT"}
        ...
        <StatsLine
          br={((homeOBJHome.draw_draw / homeOBJHome.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Draw HT - Draw FT"}
        ...
        <StatsLine
          br={((homeOBJHome.draw_away / homeOBJHome.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Draw HT - Lose FT"}
        ...
        <StatsLine
          br={((homeOBJHome.away_home / homeOBJHome.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Lose HT - Win FT"}
        ...
        />
        <StatsLine
          br={((homeOBJHome.away_draw / homeOBJHome.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Lose HT - Draw FT"}
        ...
        />
        <StatsLine
          br={((homeOBJHome.away_away / homeOBJHome.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Lose HT - Lose FT"}
    ...
    contentOUHTFT = (
      <ul>
        <StatsLine
          br={((homeOBJAll.over_0_5_HT / homeOBJAll.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Over 0.5 goals first half"}
        ...
        />
        <StatsLine
          br={((homeOBJAll.over_1_5_HT / homeOBJAll.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Over 1.5 goals first half"}
        ...
        />
        <StatsLine
          br={((homeOBJAll.over_2_5_HT / homeOBJAll.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Over 2.5 goals first half"}
        ...
        <StatsLine
          br={((homeOBJAll.over_0_5_SH / homeOBJAll.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Over 0.5 goals second half"}
        ...
        />
        <StatsLine
          br={((homeOBJAll.over_1_5_SH / homeOBJAll.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Over 1.5 goals second half"}
        ...
        />
        <StatsLine
          br={((homeOBJAll.over_2_5_SH / homeOBJAll.gamesCount) * 100).toFixed(
            0
          )}
          txt={"Over 2.5 goals second half"}
  ...
  return (
    <div className={classes.SingleStatsContainer}>
      ...
      <div id="homeButtons" className={classes.overallButtons}>
        <OverallButton o={state.single} click={setSingle} name="Home" />
